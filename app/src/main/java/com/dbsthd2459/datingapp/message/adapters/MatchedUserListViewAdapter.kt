...
class MatchedUserListViewAdapter(
    private val context: Context,
    private val items: MutableList<UserDataModel>,
    private val listener: OnItemClickListener
) : RecyclerView.Adapter<MatchedUserListViewAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val profileImage: ImageView = itemView.findViewById(R.id.profileImageArea)
        val nickname: TextView = itemView.findViewById(R.id.listViewItemNickname)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_matched_users, parent, false)
